...
namespace uopenapi::http{
    ...
    struct response_info{
        ...
        userver::server::http::HttpStatus status_code = userver::server::http::HttpStatus::kOk;
    };

    inline void move_to_response(userver::server::http::HttpResponse& res, response_info& info){
