...
namespace uopenapi::http{
    ...
    struct request_info{
        ...
        using queries_map = std::unordered_map<std::string, std::vector<std::string>>;
    ...
    inline request_info::queries_map build_query_map(const userver::server::http::HttpRequest& request){
    ...
    inline request_info make_request_info(const userver::server::http::HttpRequest& request, const request_info::queries_map& queries){
        return request_info{
