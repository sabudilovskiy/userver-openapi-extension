...
namespace uopenapi::reflective{
    ...
    std::string schema_type_name(){
        ...
        static_assert(!utils::has_anonymous_namespace<T>(), "overload this function if your type placed in anonymous namespaces");
        static_assert(!utils::is_template<T>(), "overload this function if your type placed in anonymous namespaces");
